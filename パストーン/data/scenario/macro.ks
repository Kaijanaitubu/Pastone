...
[macro name="mizuka"]
	...
	[chara_show name="mizuka" top="%top|85" zindex="%z" wait="%s_wait|true" layer="%layer|0" time="%s_time|1000" ] 
[endmacro]

[macro name="mizuka_r"]
	[chara_part name="mizuka_r" brow="%b" eyes="%e" mouth="%m" arm="%arm" effect="%effect" wait="%m_wait|false" time="%m_time|600"]
	[chara_show name="mizuka_r" top="%top|85" zindex="%z" wait="%s_wait|true" layer="%layer|0" time="%s_time|1000" ] 
[endmacro]

[macro name="roz"]
	[chara_part name="rozlaz" body="roz" roz_brow="%b" roz_eyes="%e" roz_mouth="%m" laz_brow="none" laz_eyes="none" laz_mouth="none" wait="%m_wait|false" time="%m_time|600"]
...
[macro name="laz_bow"]
	[chara_part name="rozlaz" body="laz_bow" laz_brow="none" laz_eyes="none" laz_mouth="none" roz_brow="none" roz_eyes="none" roz_mouth="none" wait="%m_wait|false" time="%m_time|600"]
	[chara_show name="rozlaz" top="%top|150" zindex="%z"  wait="s_wait|true" layer="%layer|0" time="%s_time|1000"]
[endmacro]

[macro name="rozlaz"]
	[chara_part name="rozlaz" body="rozlaz" laz_brow="none" laz_eyes="none" laz_mouth="none" roz_brow="none" roz_eyes="none" roz_mouth="none" wait="%m_wait|false" time="%m_time|600"]
	[chara_show name="rozlaz" top="%top|150" zindex="%z"  wait="s_wait|true" layer="%layer|0" time="%s_time|1000"]
[endmacro]

[macro name="rozlaz_inai"]
	[chara_part name="rozlaz" body="none" laz_brow="none" laz_eyes="none" laz_mouth="none" roz_brow="none" roz_eyes="none" roz_mouth="none"  wait="%m_wait|false" time="%m_time|600"]
	[chara_show name="RozLaz" top="%top|150" zindex="%z"  wait="s_wait|true" layer="%layer|0" time="%s_time|1000"]
[endmacro]
